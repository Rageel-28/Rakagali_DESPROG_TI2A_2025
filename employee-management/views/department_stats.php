...
// Pastikan kursor statement di-reset sebelum digunakan kembali
$stats->execute();
$all_stats = $stats->fetchAll(PDO::FETCH_ASSOC);
$stats_count = count($all_stats);

// Hitung nilai agregat total
if ($stats_count > 0) {
    ...
    // Cari nilai Max untuk visualisasi bar chart
    $max_avg_salary = max(array_column($all_stats, 'avg_salary'));
    $max_employees = max(array_column($all_stats, 'total_employees'));
}
...
<p style="margin-bottom: 2rem; color: #666;">
    Data statistik berikut diambil dari **VIEW** `department_stats` di database PostgreSQL.
</p>
...
<div class="dashboard-cards">
    <div class="card">
        ...
        <div class="number"><?php echo $stats_count; ?></div>
    </div>
...
<div style="margin-top: 3rem;">
    <h3>Visualisasi Data Sederhana</h3>
    ...
    <div class="card" style="border-left-color: #667eea;">
        ...
        <div style="margin: 0.5rem 0;">
            ...
            <div style="background: #f0f0f0; border-radius: 4px; height: 20px;">
                <div style="background: #667eea; height: 100%; border-radius: 4px; 
                     width: <?php echo ($dept['avg_salary'] / $max_avg_salary * 100); ?>%;">
                </div>
            </div>
        </div>
        <?php endforeach; ?>
    ...
    <div class="card" style="border-left-color: #27ae60;">
        ...
        <div style="margin: 0.5rem 0;">
            ...
            <div style="background: #f0f0f0; border-radius: 4px; height: 20px;">
                <div style="background: #27ae60; height: 100%; border-radius: 4px; 
                     width: <?php echo ($dept['total_employees'] / $max_employees * 100); ?>%;">
                </div>
            </div>
        </div>
        <?php endforeach; ?>
...
<div style="margin-top: 2rem; padding: 1rem; background: #e7f3ff; border-radius: 5px;">
    <strong>Informasi:</strong> Data ini di-generate secara real-time dari VIEW PostgreSQL yang menggunakan fungsi agregat.
</div>
