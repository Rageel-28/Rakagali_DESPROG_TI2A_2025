...
<body>
    ...
    <div class="container">
        <h2 style="margin-top: 10px;">Data Anggota</h2>
    ...
    <div class="text-center">© <?php echo date('Y'); ?> Copyright <a href="https://google.com/">Bagas Ardiansa Putra-TI</a></div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            // ================= SCRIPT BARU DITAMBAHKAN DARI SINI =================
            $('#simpan').click(function(){
                ...
                // Jika validasi sukses, kirim data
